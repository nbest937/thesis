...
%  % Just search for the "city" and you'll find them.
  \collegeordept{\href{http://www.neiu.edu/~deptges/}{Department of
      Geography \& Environmental Studies}}
  \university{\href{http://www.neiu.edu}{Northeastern Illinois University}}
...
%  \cityofbirth{born in XYZ}
  \collegeordept{Department of Geography \& Environmental Studies}
  \university{Northeastern Illionois University}
  \crest{\includegraphics[width=4cm]{logo}}
\fi

%\renewcommand{\submittedtext}{change the default text here if needed}
\degree{Master of Arts in Geography \& Environmental Studies}
