...
and natural phenomena \citep{Fisher2005a}.  \todo{Warning--page
  numbers missing in Fisher2005a} These maps are necessarily functions
...
Allocation Model (SPAM) \citep{You2006} \todo{Warning--there's a
  number but no series in You2006} are further informed by
...
The tables, charts, and maps included in this document will generated
