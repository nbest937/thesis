...
\begin{table}[ht]
  \begin{center}
    \begin{tabular}{|p{1in}|p{4in}|}
      ...
      rice & rice \\
      \hline
      other cereals & \Sexpr{ paste( sort( tolower( cropTable[ cropTable$cat == "cereals", "crop"])), collapse="; ")} \\
      \hline
      soybean & soybean \\
      \hline
      sugarcane & sugarcane \\
      \hline
      forage &  \Sexpr{ paste( sort( tolower( cropTable[ cropTable$cat == "forage", "crop"])), collapse="; ")} \\
      \hline
      other field crops &  \Sexpr{ paste( sort( tolower( cropTable[ cropTable$cat == "field_crop", "crop"])), collapse="; ")} \\
      \hline
      shrub crops &  \Sexpr{ paste( tolower( sort( cropTable[ cropTable$cat == "shrub_crop", "crop"])), collapse="; ")} \\
      \hline
      tree crops &  \Sexpr{ paste( sort( tolower( cropTable[ cropTable$cat == "tree_crop", "crop"])), collapse="; ")} \\
      \hline
