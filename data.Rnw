...
nlcd <- list( pri=raster( "nlcd2001.tif"))
...
thumbNlcd <- mlctReclass( thumbNlcd, nlcdReclassMatrix, overwrite= overwriteRasters)

thumbNlcdPlot <- peelMap(thumbNlcd$pri, 0.05)


thumbNlcd$Amin <- 1
thumbNlcd <- coverFractions( thumbNlcd, mosaic=FALSE, overwrite=TRUE, progress= "text")
...
## gdalwarp -of VRT -ts $(( 260*12)) 0  thumb_2001_lct1_reclass.tif thumb_2001_lct1_reclass_resamp.vrt
